  ...
  menuColaborador,
	{
      ...
      {
				path: "/apps/aprobacion-servicios",
      ...
      {
				path: "/apps/desconformidad-servicios",
			...
			{
				path: "/apps/permisos-seguridad",
				title: "Permisos Per. Seg.",
				icon: "mdi mdi-book-multiple",
				class: "",
				label: "",
				labelClass: "",
	...
	// 	class: "has-arrow",
	// 	label: "13",
	// 	labelClass: "side-badge badge bg-danger",
	// 	extralink: false,
	// 	submenu: [
	// 		{
