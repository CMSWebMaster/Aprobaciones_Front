...
export class WorkerPermissionSummaryComponent {
	...
	generatePdf() {
		...
		doc.setFontSize(8);
		doc.text('Lima (X) Chorrillos ( ) Surco ( )', 150, 10);
		...
		doc.setFontSize(8);
		doc.text('1570', 10, 30);
		doc.text('JORGE AUGUSTO AGUSTIN NAVARRO VEGA', 40, 30);
		...
		doc.rect(25, 48, 4, 4); // Checkbox
		doc.rect(25, 53, 4, 4); // Checkbox
		...
		doc.text('DÍA/MES/AÑO', 30, 65);
		doc.text('HORA/MIN', 90, 65);
		doc.text('HASTA:', 10, 70);
		doc.text('DÍA/MES/AÑO', 30, 70);
		doc.text('HORA/MIN', 90, 70);
		...
		// Encabezado con logo y texto
		doc.setFontSize(8);
		doc.text('Lima (X) Chorrillos ( ) Surco ( )', 150, 145 + additionalSpace);
		...
		// Datos del empleado
		doc.setFontSize(8);
		doc.text('1570', 10, 165 + additionalSpace);
		doc.text('JORGE AUGUSTO AGUSTIN NAVARRO VEGA', 40, 165 + additionalSpace);
		...
		doc.rect(25, 183 + additionalSpace, 4, 4); // Checkbox
		doc.rect(25, 188 + additionalSpace, 4, 4); // Checkbox
		...
		doc.text('DÍA/MES/AÑO', 30, 200 + additionalSpace);
		doc.text('HORA/MIN', 90, 200 + additionalSpace);
		doc.text('HASTA:', 10, 205 + additionalSpace);
		doc.text('DÍA/MES/AÑO', 30, 205 + additionalSpace);
		doc.text('HORA/MIN', 90, 205 + additionalSpace);
